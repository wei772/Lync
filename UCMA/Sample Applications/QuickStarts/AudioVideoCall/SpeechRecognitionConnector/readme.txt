...
The application initalizes the platform and calls out to the user specified, uses speech recognition for a small period of time, stops, then tears down the speech recognition connector and platform. The application prints logging to the console, and then quits; shutting the platform down normally.
...
Features:
	...
	- Basic SpeechRecognitionConnector usage.
